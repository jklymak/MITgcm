...
C     2-dim. fields
     ...
     &  var_bot_vert_scale, var_bot_Nsq,
     &  var_bot_uscale, var_bot_vscale
     ...
     &                            nSx,nSy)
      ...
      _RL var_bot_uscale(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL var_bot_vscale(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL var_bot_nsq(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL var_bot_vert_scale(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
